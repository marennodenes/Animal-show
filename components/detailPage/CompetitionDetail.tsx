...
export default function CompetitionDetail({
 ...
 //Like-funksjon
  ...
  const isCompetitionOver = competition ? new Date() > new Date(competition.end_date) : false;
  ...
  return (
    !competition ? null : (<div>
      ...
      {isParticipating && !isCompetitionOver? (
        ...
        <div className="mt-6 flex items-center gap-2 bg-gray-100 text-gray-600 font-medium px-4 py-2 rounded shadow-sm border border-gray-300">
